...
namespace BotTimeICSharpCode.AvalonEdit.CodeCompletion
{
    /// <summary>
    ...
    public class CompletionImage
    {
        ...
        static BitmapImage LoadBitmap(string name)
        {
            ...
            sb.Append(currentAssemblyName + ".CodeCompletion.Images." + name + ".png");
            var stream = currentAssembly.GetManifestResourceStream(sb.ToString());
