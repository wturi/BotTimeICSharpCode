...
namespace BotTimeICSharpCode.CodeCompletion.DataItems
{
    class CompletionData : ICompletionData, AvalonEdit.CodeCompletion.ICompletionData
    {
        ...
        public virtual void Complete(BotTimeICSharpCode.AvalonEdit.Editing.TextArea textArea, ISegment completionSegment, EventArgs insertionRequestEventArgs)
        {
        ...
        object BotTimeICSharpCode.AvalonEdit.CodeCompletion.ICompletionData.Description
        {
